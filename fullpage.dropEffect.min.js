	...
	window.fp_dropEffectExtension = function () {
		...
		function V(e) {
			...
			t && u.closest(t, n + ' a')
				...
				: u.closest(t, v.menu + ' [data-menuanchor]') &&
				  function (e) {
						k && e.preventDefault();
				  }.call(t, e);
		}
		...
		function q(e) {
			...
			(!Q('slides') && n) || (!Q('sections') && !n)
				? (t = s.scrollingSpeed)
				: ((t = f.speed ? f.speed : v.scrollingSpeed), (o = t)),
				m.setScrollingSpeed(t);
		}
		(i.afterLoad = function () {}),
			(i.onLeave_ = function (e) {
				if (((e.activeSection = m.getActiveSection().item), !d)) {
					var t = e.activeSection.getAttribute('data-drop');
					('all' === t || e.direction === t) && l
						? i.turnOn()
						: (i.destroy('internal'),
						  (e.dtop = h.getDestinationPosition(e.element)));
				}
			}),
			...
			(i.init = function () {
				if (!K()) {
					...
					(e = c(p)[0]),
						...
						(d = !c('.fp-section[data-drop]').length),
						(s = u.deepExtend({}, v)),
						(r = s.autoScrolling),
						(f = u.deepExtend(P, v.dropEffectOptions)),
						(o = f.speed ? f.speed : v.scrollingSpeed),
						q({ xMovement: 'none' }),
						j((a = (o - 100) / 2)),
						(t =
							'\n                .fp-effect-1 {\n                    top     : 0;\n                    bottom  : 0;\n                    right   : 0;\n                    left    : 0;\n                    width   : 100%;\n                    height  : 100%;\n                    position: fixed;\n                    overflow: hidden;\n                    z-index: '.concat(
						...
						Z.appendChild(F),
						(T = F.getAttribute('d')),
						(_ = F.getAttribute('data-path1')),
						(B = F.getAttribute('data-path2')),
						m.setAutoScrolling(!0),
						(v.scrollBar = !1),
						(v.animateAnchor = !1);
					var n = Q('slides') ? Y(w) : '',
						i = Q('sections') ? Y(b) : '';
					v.dropEffect && U(C, i + n), h.removeAnimation(c(A)), (l = !0);
				}
			});
		var H = !(i.destroy = function (e) {
			if (l && !R) {
				...
				h.removeAnimation(t),
					...
					(k = !1),
					u.remove(c('#fp-drop-animation')),
					u.remove(c(S)),
					u.remove(c(y)),
					x.parentNode.removeChild(x),
					window.removeEventListener('hashchange', X),
					t && t.removeEventListener('destroy', J),
					m.setScrollingSpeed(s.scrollingSpeed),
					m.setAutoScrolling(r);
				var n = c(L, c('.fp-section.active')[0])[0];
				null != n && 'internal' !== e && (h.silentLandscapeScroll(n), (l = !1)),
					(v.dropEffect = !1),
					(R = !0);
			}
		});
		...
		function Q(e) {
			return !0 === v.dropEffect || v.dropEffect === e;
		}
		function U(e, t) {
			if (!c('#' + e).length) {
		...
		(i.turnOn = function () {
			(v.dropEffect = s.dropEffect),
				K() ||
					(i.init(),
					(R = !1),
					window.scrollTo(0, 0),
					Q('sections') && h.silentScroll(0));
		}),
			(i.apply = function (e) {
			...
			(i.performMovement = function (a) {
				(a.activeSection = m.getActiveSection().item),
					void 0 === a.element &&
						((a.element = a.destiny),
				...
				if (!k && !R) {
					...
					x.setAttribute(
						...
						anime({
							targets: d,
							d: [
								{ value: c, easing: f.animation1.easeIn },
								{ value: l, easing: f.animation1.easeOut },
							],
							...
							complete: function (e) {
								...
								u.addClass(a.element, g),
									...
									u.isFunction(v.dropLeaves) &&
										v.dropLeaves.apply(a.element, [
											h.nullOrSection(a.activeSection),
											h.nullOrSection(a.element),
											a.direction,
										]),
									h.updateState(),
									(n = (t = {
									...
									anime({
										...
										complete: function (e) {
											(k = !1),
												...
												u.isFunction(v.dropEnds) &&
													v.dropEnds.apply(o.element, [
														o.activeSection,
														o.element,
														o.direction,
													]);
			...
			(i.setOption = function (e, t) {
				({
					...
					direction: function () {
						i.destroy(),
							(s.dropEffect = t),
							(v.dropEffectOptions.color = v.dropEffectOptions.color),
							(v.dropEffectOptions.speed = v.dropEffectOptions.speed),
							i.turnOn();
					},
				}[e]());
			}),
